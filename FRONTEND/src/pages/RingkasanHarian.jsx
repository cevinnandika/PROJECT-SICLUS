...
const RingkasanHarian = ({ inspections = [], trips = [], onResetAllLogs }) => {
  return (
    <div className="space-y-6 text-left max-w-5xl mx-auto pb-6">
      {/* Title */}
      <h2 className="text-2xl font-black text-[#00206B] m-0 tracking-wide uppercase">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm space-y-4">
            <h3 className="text-lg font-extrabold text-[#00206B] m-0 pb-3 border-b border-slate-100">
              Perjalanan Pagi
            </h3>
            ...
            <div className="flex items-center gap-4 bg-slate-50 rounded-xl p-4 border border-slate-100">
              ...
              <div className="flex-1 flex justify-between items-center text-sm">
                ...
                <div className="text-right">
                  ...
                  <span className="text-xs text-slate-400 font-semibold block mt-0.5">KM 45,200</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-slate-50 rounded-xl p-4 border border-slate-100">
              ...
              <div className="flex-1 flex justify-between items-center text-sm">
                ...
                <div className="text-right">
                  ...
                  <span className="text-xs text-slate-400 font-semibold block mt-0.5">KM 45,230</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-2 text-sm">
              ...
              <span className="text-base font-black text-[#00206B]">42 Siswa</span>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm space-y-4">
            ...
            <div className="bg-[#FCE8E6] border border-[#FAD2CF] text-[#C5221F] rounded-xl p-4 flex items-center gap-3 text-sm font-bold">
              <span>⚠️</span>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white border border-slate-100 rounded-xl p-5 shadow-sm space-y-3">
            <h4 className="text-sm font-extrabold text-[#00206B]">Statistik Hari Ini</h4>
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-[#00206B]">42</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-500">Jarak Tempuh</span>
                <span className="font-bold text-[#00206B]">30 KM</span>
              </div>
            </div>
          </div>
