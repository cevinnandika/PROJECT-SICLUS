...
function App() {
      ...
      case 'kendala':
        ...
        return (
          <Kendala 
            ...
            onSubmit={handleInspectionIssues}
          />
        );
      ...
      case 'ringkasan':
        return (
          <RingkasanHarian 
            ...
            trips={trips} 
            onResetAllLogs={handleResetLogs}
          />
        );
  ...
  const getPageTitle = () => {
    ...
    switch (currentPage) {
      ...
      case 'persiapan': return 'Laporan';
      case 'inspeksi': return 'Laporan';
      case 'kendala': return 'Laporan';
      case 'titikstart': return 'Laporan';
      case 'penumpang': return 'Laporan';
      case 'ringkasan': return 'SICLUS';
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex justify-center items-center font-sans antialiased">
      <MobileLayout 
        title={getPageTitle()} 
        onBack={user && currentPage !== 'beranda' && currentPage !== 'ringkasan' ? handleBack : null}
      >
        {renderPage()}
      </MobileLayout>
      {user && <BottomNav activeTab={currentPage} setActiveTab={setCurrentPage} />}
    </div>
  );
}
